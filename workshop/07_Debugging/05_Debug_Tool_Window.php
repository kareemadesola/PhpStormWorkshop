...
// 1. Navigate to the Customer class constructor and place a breakpoint in it.
...
// 3. Use the context menu to debug the current PHP script. This should launch the debugger and break on our first breakpoint in Customer.php.
//    The Debug Tool Window shows us frames on the left, in other words which line of code called into which line of code.
//    We can see the Customer.php file is called into from the current file. In large applications, this allows walking the execution stack.
// 4. Click the "05_Debug_Tool_Window.php" entry from the frames list. We can see where the Customer constructor is called.
...
// 10. From the Debug Tool Window, use the Evaluate Expression toolbar button (or Alt+F8) to change the name. E.g. evaluate:  .
