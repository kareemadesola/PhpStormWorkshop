...
use Refactoring12\JetBrains\Person;
...
class QuickFixes
{
    ...
    // 2. A warning highlight should be shown in the following function because the class Customer is unknown.
    //    Place the caret over Customer and use Quickfix to import the class.
