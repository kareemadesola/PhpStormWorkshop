...
foreach ($people as $person) {
    // 1. Auto completion on $person will not show anything about the Customer class.
    ...
    //        /** @var $people Customer[] */
    //    This tells PhpStorm the array contains Customer objects.
    //    Type $person-> and see for yourself that we now have completion.
    // $person->

    // 3. Place the cursor on $person and use Quick Documentation.

    // 4. Place the cursor on Customer and use Quick Documentation.

    // 5. Navigate to the Customer class and add PHPDoc annotations on the class.
    ...
    //    on the Customer class. Try it here, by typing: $person->A
    //
